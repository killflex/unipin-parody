...
<head>
    ...
    <title>UniPin - Google Wallet (USD)</title>
                ...
                <div class="card card-product">
                    <div class="card-body card-chest">
                        <div class="d-flex flex-row justify-items-start">
                            ...
                            <div>
                                <div class="game-publisher">
                                    ...
                                    <p class="product-dev text-muted">Google</p>
                                </div>

                                <p class="product-name fs-lg-5">Google Wallet (USD)</p>
                            </div>
                        </div>

                        <div class="product-desc mt-1" id="text-container">
                            <p class="p-0 m-0"><strong><em>**Ini hanya berlaku untuk akun Google Play yang terdaftar di wilayahnya.**</em></strong></p>
                            <span class="moreText">
                                <p class="mt-3">Ingin beli voucher Google Play? Di UniPin saja! UniPin merupakan partner resmi bagi kamu yang ingin mendapatkan kode voucher Google Play untuk berbagai kebutuhan. Tersedia nominal mulai dari 1 USD sampai 100 USD.</p>
                                <p>Beli Google Wallet di UniPin bisa dilakukan via Visa dan MasterCard. Top up Google Wallet juga bisa dilakukan tanpa harus mendaftar, login dan tanpa ribet aktifasi.</p>
                                <p>Google Play adalah operator distribusi layanan digital yang dioperasikan dan dikembangkan oleh Google. Pengguna bisa menikmati layanan gratis maupun berbayar. Untuk layanan berbayar, pembayaran bisa dilakukan dengan menggunakan voucher Google Play.</p>
                            </span>
                        ...
                        <div class="product-list">
                            <div class="list-icon">
                                <a href="https://play.google.com/store?utm_source=apac_med&utm_medium=hasem&utm_content=Oct0121&utm_campaign=Evergreen&pcampaignid=MKT-EDR-apac-id-1003227-med-hasem-py-Evergreen-Oct0121-Text_Search_BKWS-BKWS|ONSEM_kwid_43700064630745370_creativeid_435321981087_device_c&gclid=CjwKCAjwloCSBhAeEiwA3hVo_bwrpMbnMaNF63p7eFzErZMijkI-_vpzOzMq2RcoAMD_vDIeKA368xoCPd0QAvD_BwE" target="_blank">
                            ...
                            <div class="list-icon">
                                <a href="https://support.google.com/accounts/community?hl=id" target="_blank">
                                ...
                                <div class="input-grid-items">
                                    ...
                                    <label for="1" class="lbl-radio">
                                        <div class="display-box">
                                            <span class="nominal">Google Wallet 1 USD</span>
                                        </div>
                                    </label>
                                </div>
                                <div class="input-grid-items">
                                    ...
                                    <label for="2" class="lbl-radio">
                                        <div class="display-box">
                                            <span class="nominal">Google Wallet 2 USD</span>
                                        </div>
                                    </label>
                                </div>
                                <div class="input-grid-items">
                                    ...
                                    <label for="3" class="lbl-radio">
                                        <div class="display-box">
                                            <span class="nominal">Google Wallet 5 USD</span>
                                        </div>
                                    </label>
                                </div>
                                <div class="input-grid-items">
                                    ...
                                    <label for="4" class="lbl-radio">
                                        <div class="display-box">
                                            <span class="nominal">Google Wallet 10 USD</span>
                                        </div>
                                    </label>
                                </div>
                                <div class="input-grid-items">
                                    ...
                                    <label for="5" class="lbl-radio">
                                        <div class="display-box">
                                            <span class="nominal">Google Wallet 15 USD</span>
                                        </div>
                                    </label>
                                </div>
                                <div class="input-grid-items">
                                    ...
                                    <label for="6" class="lbl-radio">
                                        <div class="display-box">
                                            <span class="nominal">Google Wallet 20 USD</span>
                                        </div>
                                    </label>
                                </div>
                                <div class="input-grid-items">
                                    ...
                                    <label for="7" class="lbl-radio">
                                        <div class="display-box">
                                            <span class="nominal">Google Wallet 30 USD</span>
                                        </div>
                                    </label>
                                </div>
                                <div class="input-grid-items">
                                    ...
                                    <label for="8" class="lbl-radio">
                                        <div class="display-box">
                                            <span class="nominal">Google Wallet 50 USD</span>
                                        </div>
                                    </label>
                                </div>
                                <div class="input-grid-items">
                                    ...
                                    <label for="9" class="lbl-radio">
                                        <div class="display-box">
                                            <span class="nominal">Google Wallet 60 USD</span>
                                        </div>
                                    </label>
                                </div>
                                <div class="input-grid-items">
                                    ...
                                    <label for="10" class="lbl-radio">
                                        <div class="display-box">
                                            <span class="nominal">Google Wallet 70 USD</span>
                                        </div>
                                    </label>
                                </div>
                                <div class="input-grid-items">
                                    ...
                                    <label for="11" class="lbl-radio">
                                        <div class="display-box">
                                            <span class="nominal">Google Wallet 100 USD</span>
                                        </div>
                                    </label>
                                </div>
                            </div>
